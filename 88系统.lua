...
local function checkWhitelist()
    ...
    if WHITELIST[playerUID] then
        ...
        local loadSuccess, loadErr = pcall(function()
            local scriptContent = game:HttpGet('https://raw.githubusercontent.com/aaaaaaajwjnwj/-/refs/heads/main/Fin%20Hub%20%E6%BA%90%E7%A0%81.lua')
