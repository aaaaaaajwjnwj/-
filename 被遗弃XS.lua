...
leftBox:AddLabel("  XS脚本 ")
leftBox:AddLabel("----------------------------------")
leftBox:AddLabel("   状态:永久免费  ")
leftBox:AddLabel("   更新:2026.2.4  ")
leftBox:AddLabel("     ")
leftBox:AddLabel("----------------------------------")
leftBox:AddLabel("   群聊:1075226283  ")
leftBox:AddLabel("   群聊:1015159552  ")
leftBox:AddLabel("   群聊:  ")
leftBox:AddLabel("----------------------------------")
...
bottomBorder:AddLabel("感谢使用XS脚本 - 祝您游戏愉快！")
bottomBorder:AddLabel("═════════════════════════════════")
...
local MenuGroup = Tabs["UI Settings"]:AddLeftGroupbox("Menu")
    ...
    ThemeManager:SetFolder("Xs Hub") 
SaveManager:SetFolder("Xs Hub/specific-game") 
