...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "帅脚本V2"; Text ="启动中"; Duration = 2; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "帅脚本V2"; Text ="3"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "帅脚本v2"; Text ="2"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "帅脚本v2"; Text ="1"; Duration = 2; })wait("1")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "帅脚本v2"; Text ="成功启动"; Duration = 3; })
