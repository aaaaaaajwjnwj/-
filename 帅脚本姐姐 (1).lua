...
contentLabel.Text = "shuaiAR脚本加载完成开始享受吧。" 
...
Tabs.CSJTab:Button({
    ...
    Desc = "卡密xiao",
    Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/aaaaaaajwjnwj/-/refs/heads/main/%E6%AF%94%E4%B8%8D%E4%B8%8A%E6%8A%A4.lua"))()
    end
})
...
Tabs.CSJTab:Button({
    ...
    Desc = "",
    Callback = function()
loadstring(game:HttpGet("https://pandadevelopment.net/virtual/file/7fea4c944bf43f48"))()
    end
})
...
Tabs.CSJTab:Button({
    ...
    Desc = "",
    Callback = function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/tfcygvunbind/Apple/main/
    end
})
...
Tabs.CSJTab:Button({
    ...
    Desc = "",
    Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/eksan966/SX-Hub/refs/heads/main/SX-Hub"))()
    end
})
