...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "XS HUB脚本中心V4"; Text ="启动中"; Duration = 2; })
...
local win = ui:new("XS HUB")
--
local UITab1 = win:Tab("『信息』",'7734068321')

local about = UITab1:section("『作者信息』",false)

about:Label("XS HUBV3")
about:Label("作者：XS HUB")
about:Label("qq群1015159552")
about:Label("师附      ")
about:Label("感谢使用")
