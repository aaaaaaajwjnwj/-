...
Notification:Notify(
    {Title = "欢迎使用小帅黑白脚本", Description = "请加入QQ群：946671668"},
...
local Window = WindUI:CreateWindow({
    Title = '<font color="#FF3333">小</font><font color="#FF9933">帅</font><font color="#FFFF33">脚</font><font color="#33FF33">本</font>',  
