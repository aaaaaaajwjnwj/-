...
local Translations = {
    ["CloseWindowTitle"] = "后面太多字了不想改",
    ["CloseWindowConfirm"] = "黑白肯定同意二改😭😭",
    ["CancelBtn"] = "取消",
    ["CloseBtn"] = "关闭窗口",
    ["LockedText"] = "锁定",
    ["Close Window"] = "关闭窗口",
    ["Do you want to close this window? You will not be able to open it again."] = "我问过黑白了他说话了肯定同意了😭😭，再用用呗🙏🙏🙏",
    ["Cancel"] = "取消",
    ["Locked"] = "锁定",
    ["Search"] = "搜索",
    ["No results found."] = "没有",
...
local function checkBlacklist()
    ...
    if BLACKLIST[tostring(player.UserId)] or BLACKLIST[player.Name] then
        -- 尝试踢出玩家
        pcall(function()
            player:Kick("你已被列入黑名单，无法使用帅二改黑白脚本。")
        end)
        return true
    end
    return false
...
Notification:Notify(
    {Title = "欢迎使用帅二改黑白脚本", Description = "请加入QQ群：946671668"},
...
local Window = WindUI:CreateWindow({
    Title = '<font color="#FF3333">帅</font><font color="#FF9933">二</font><font color="#FFFF33">脚</font><font color="#33FF33">本</font>    ',  
    Icon = "badge-check",
    Author = "作者:帅二改",
...
local LanguageService = {
    ...
    Translations = {
        -- 基础界面文本
        [" 二改脚本"] = {en = "Black & White Script", ja = "二改脚本牛逼"},
        ["作者:25年的黑白"] = {en = "Author: Unknown Quantity B&W", ja = "作者: 帮助黑白的小帅"},
        ["欢迎使用二改脚本"] = {en = "Welcome to B&W Script", ja = 黑白学日语"},
