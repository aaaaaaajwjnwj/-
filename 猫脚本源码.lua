...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "帅脚本"; Text ="帅脚本"; Duration = 4; })
...
about:AddParagraph("作者QQ3871788134")
about:AddParagraph("qq群聊1075226283")
about:AddParagraph("作者帅王")
