...
loadstring(game:HttpGet("loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Invinicible-Flight-R15-45414"))()"))()
end) 
...
--=======姥爷司空别翻过头了===========
--=======姥爷司空别翻过头了===========
Button(Tabjb, "点击此处复制XS私人qq以提供你的脚本", function()
...
Button(Tabjb, "冷脚本", function() 
        loadstring(game:HttpGet("https://raw.githubusercontent.com/aaaaaaajwjnwj/-/refs/heads/main/obfuscated_script-1770031863652.lua"))()
end)
...
Button(Tab18, "XS通缉", function() 

loadstring(game:HttpGet("https://raw.githubusercontent.com/shenmi9178/Dong-s-script/refs/heads/main/XS%E9%80%9A%E7%BC%89.lua"))()    
end)
Button(Tab19, "XS被遗弃", function()
...
Button(Tabd, "XS私人qq号码[点我复制]", function()
    setclipboard("3381690468")
end)
