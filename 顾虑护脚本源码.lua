...
local Window = OrionLib:MakeWindow({Name = "😎脚本", HidePremium = false, SaveConfig = true,IntroText = "😎脚本", ConfigFolder = "😎脚本"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "😎脚本"; Text ="😎脚本"; Duration = 4; })
...
about:AddParagraph("qq群1075226283")
