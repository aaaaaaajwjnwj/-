...
-- 发送气泡聊天信息
game:GetService("TextChatService"):DisplayBubble((LocalPlayer.Character or LocalPlayer.CharacterAdded:Wait()):WaitForChild("Head"), "欢迎使用帅脚本")
...
NoticeSection:Label("群:1075226283")
NoticeSection:Label("作者:帅")
NoticeSection:Label("完全免费")
NoticeSection:Label("半缝合脚本")
NoticeSection:Label("持续云更新")
NoticeSection:Label("QQ：3871788134")
